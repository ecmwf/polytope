...
with GDALEnv():
    ...
    from pyogrio._ogr import _get_drivers_for_path, _register_drivers
    from pyogrio._ogr import get_gdal_config_option as _get_gdal_config_option
    from pyogrio._ogr import get_gdal_data_path as _get_gdal_data_path
    from pyogrio._ogr import (
        get_gdal_geos_version,
        get_gdal_version,
        get_gdal_version_string,
    )
    from pyogrio._ogr import init_gdal_data as _init_gdal_data
    from pyogrio._ogr import init_proj_data as _init_proj_data
    from pyogrio._ogr import ogr_list_drivers
    from pyogrio._ogr import set_gdal_config_options as _set_gdal_config_options
