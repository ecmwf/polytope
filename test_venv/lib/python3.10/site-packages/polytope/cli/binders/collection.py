...
# list
doc = parse(Client.list_collections.__doc__)
...
def list(**kwargs):
    ...
    Client(**session_args).list_collections(**other_args)


# describe
doc = parse(Client.describe_collection.__doc__)
...
def describe(**kwargs):
    session_args, other_args = helpers.filter_session_args(**kwargs)
    Client(**session_args).describe_collection(**other_args)
