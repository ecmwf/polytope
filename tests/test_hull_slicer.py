...
import polytope_feature.engine.hullslicer
...
class TestHullSlicer:
    ...
    def test_3D(self):
        ...
        print(p3)
        p2 = polytope_feature.engine.hullslicer.slice(p3, "c", 0.5, 2)
        print(p2)
        p1 = polytope_feature.engine.hullslicer.slice(p2, "b", 0.5, 1)
        print(p1)
    ...
    def test_4D(self):
        ...
        print(p)
        while len(p.axes()) > 1:
            p = polytope_feature.engine.hullslicer.slice(p, p._axes[-1], 0.5, -1)
            print(p)
