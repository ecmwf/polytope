...
class TestQuadTreeSlicer:
    def setup_method(self, method):
        ...
        # print(len(grid.clon))
        self.longitudes = [val * 180 / math.pi for val in grid.clon.values]
        self.latitudes = [val * 180/math.pi for val in grid.clat.values]
    ...
    def test_quad_tree_slicer_extract(self):
        ...
        for i in range(len(leaves)):
            ...
            lat = cubepath["longitude"][0]
            lon = cubepath["longitude"][1]
