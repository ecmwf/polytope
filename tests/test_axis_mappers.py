...
class TestAxisMappers():
    ...
    def test_int_axis(self):
        axis = IntAxis()
        assert axis.parse(2) == 2.
        assert axis.to_float(2) == 2.
        assert axis.from_float(2) == 2.
    ...
    def test_float_axis_cyclic(self):
        ...
        axis.range = [2,4]
        assert axis.remap([0,5]) == [[1.999999999999, 4.000000000001], [1.999999999999, 4.000000000001], [1.999999999999, 3.000000000001]]
        axis.range = [2.3, 4.6]
        remapped = axis.remap([0.3, 5.7])
        assert remapped == [[2.5999999999989996, 4.600000000001], [2.2999999999989997, 4.600000000001], [2.2999999999989997, 3.4000000000010004]]

        # Test the to_cyclic_value function
        axis.range = [1,3]
        remapped = axis.remap([0,7])
        assert remapped == [[1.999999999999, 3.000000000001], [0.999999999999, 3.000000000001], [0.999999999999, 3.000000000001], [0.999999999999, 3.000000000001]]
    ...
    def test_timestamp_axis(self):
        ...
        assert axis.remap([time1, time2]) == [[pd.Timestamp('2017-01-01 11:00:00'), pd.Timestamp('2017-01-01 12:00:00')]]
