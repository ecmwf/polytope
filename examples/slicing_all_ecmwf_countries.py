...
class Test():
    ...
    def test_slice_country(self):
        ...
        # Shapefile taken from https://hub.arcgis.com/datasets/esri::world-countries-generalized/explore?location=-0.131595%2C0.000000%2C2.00
        shapefile = gpd.read_file("./examples/data/World_Countries__Generalized_.shp")
        country = shapefile
        shapefile = shapefile.set_index("COUNTRY")

        ECMWF_country_list_multipolygon = ["Croatia", "Denmark", "Estonia", "Finland", "France", "Germany", "Greece", "Ireland", "Italy", "Netherlands", "Norway", "Spain", "Sweden", "Turkiye", "United Kingdom"]
        ECMWF_country_list_polygon = ["Austria", "Belgium", "Iceland", "Luxembourg", "Portugal", "Serbia", "Slovenia", "Switzerland"]
