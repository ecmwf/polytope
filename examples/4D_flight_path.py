...
class Test():
    ...
    def test_slice_shipping_route(self):
        ...
        texture = np.asarray(Image.open('./examples/data/earth_image.jpg'.format("Earth"))).T
        radius = 1
        ...
        padded_point_upper = [0.23,0.23,np.timedelta64(1850000000000, "ns"), 1.]
        padded_point_lower = [-0.23,-0.23,np.timedelta64(-1850000000000, "ns"), 1.]
        ...
        flight_path = go.Scatter3d(x = x, y = y, z = z, mode="markers", marker = dict(size = 1.5, color = intensity_color, colorscale = "YlOrRd"))
